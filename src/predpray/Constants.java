...
public class Constants {
	...
	public static final int INIT_NUMBER_OF_RABBITS = 50 * MAP_MULTIPLIER;
	...
	public static final double MIN_FOXES_PER_RABBITS = 100000000000000d;
	...
	public static final int GRASS_MAX_LIMIT = 6;
